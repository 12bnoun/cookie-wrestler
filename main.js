...
let TouchState = (reason) =>
{
    switch (reason)
    {
        ...
        case Draw:
        {
            DrawText("Tap", gameWidth*0.5, gameHeight*0.5, 36, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 12);
        } break;
    }
}
...
let MainMenu = (reason) =>
{
    switch (reason)
    {
        ...
        case Draw:
        {
            ...
            DrawText("Wrestler 19", gameWidth*0.5, gameHeight*0.3, size, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 20, color);
            DrawText("Wrestler 19", gameWidth*0.5, gameHeight*0.3, size, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 12, "#000");
            DrawText("Weighing in at 404 lbs!", gameWidth*0.5, gameHeight*0.45, 32, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 9, "#000");
            if (Date.now()%800 < 600)
            {
                DrawText("- Tap To Start -", gameWidth*0.5, gameHeight*0.85, 32, "#FFD800", 0, "MinecraftiaRegular", "Bold", "center", "center", 9);
            }

            let sfxDisplay = "SFX: " + (sfxOn ? "Yes" : "No");
            DrawText(sfxDisplay, gameWidth - 20, gameHeight*0.9, 24, "#FFF", 0, "MinecraftiaRegular", "Bold", "right", "center", 7);
            let musicDisplay = "MUSIC: " + (musicOn ? "Yes" : "No");
            DrawText(musicDisplay, gameWidth - 20, gameHeight*0.97, 24, "#FFF", 0, "MinecraftiaRegular", "Bold", "right", "center", 7);
...
let GameOver = (reason) =>
{
    switch (reason)
    {
        ...
        case Draw:
        {
            ...
            if (gameOverState >= 2)
            {
                DrawText("Game Over", gameWidth*0.5, gameHeight*0.3, 72, "#DB0000", 0, "MinecraftiaRegular", "Bold", "center", "center", 12);
            }

            if (gameOverState >= 4)
            {
                DrawText("Eliminations: " + player.score, gameWidth*0.5, gameHeight*0.42, 36, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 8);
            }
            ...
            if (gameOverState >= 6)
            {
                ...
                DrawText("Best: " + highScore, gameWidth*0.5, gameHeight*0.52, 36, "#FFF", 0, "MinecraftiaRegular", "Bold", "center", "center", 8);
            }
            ...
            if (gameOverState >= 8)
            {
                ...
                {
                    DrawText("New Best!", gameWidth*0.5, gameHeight*0.63, 36 + Math.abs(Math.sin(Date.now()*0.005))*10.0, "#04D84E", -10, "MinecraftiaRegular", "Bold", "center", "center", 10);
                }
            }
        } break;
    }
