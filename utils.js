...
let DrawHud = () =>
{
    ...
    hudScoreScale *= 0.85;
    DrawText(player.score.toString(), gameWidth - 40, 50, 40 + (20 * hudScoreScale), "#FFF", 0, "MinecraftiaRegular", "Bold", "right", "center", 8);

    if (isFrenzy)
    {
        DrawText("Wrestler Rush!", gameWidth*0.5, gameHeight*0.2, 36 + Math.abs(Math.sin(Date.now()*0.0075))*10.0, "#FFD800", -2, "MinecraftiaRegular", "Bold", "center", "center", 10);
    }
}
