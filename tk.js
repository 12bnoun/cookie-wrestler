...
let DrawText = (text, x, y, fontSize = 12, fillStyle = "#FFF", angle = 0, fontName = "MinecraftiaRegular", fontStyle = "", align = "left", baseline = "bottom", outlineWidth = 0, outlineColor = "#000") =>
{
    ctx.save();
    ctx.translate(x, y);
    ctx.rotate(angle * Deg2Rad);
